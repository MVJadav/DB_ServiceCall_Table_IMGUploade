...
struct DBQuery {
    ...
    func getGoalType() ->String {
        return "select * from \(DBTableName.Response)"
    }
...
//            }
    ...
    static func InsertServiceResponse(strQuery: String) {
        ...
        if (sqlite3_open(dbpath, &database) == SQLITE_OK) {
            ...
            statement = nil
            let insertStatement: NSString = strQuery as NSString
